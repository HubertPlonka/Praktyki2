...
HD_PWD='C:/Users/hubel/Desktop/Praktyki2/Licznik/Licznik.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log licznik.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source licznik.tcl
